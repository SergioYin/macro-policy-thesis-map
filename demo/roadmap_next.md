...
| next-002 | Agent reuse | Stabilize protocol JSON field names before adding optional adapters. | workflow_protocol.json remains backwards-readable by agents using protocol_id macro-policy-thesis-map.v1.2. | remote orchestration, repository workflow files |
