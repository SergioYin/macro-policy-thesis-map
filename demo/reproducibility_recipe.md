...
| 47 | PYTHONPATH=src python -m macro_policy_thesis_map.cli cold-start-walkthrough --root . | deterministic demo artifact update |
| 48 | PYTHONPATH=src python -m macro_policy_thesis_map.cli release-manifest --root . | release manifest records settled hashes |
